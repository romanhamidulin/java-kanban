...
class EpicTest {
    ...
    public void epicIsShouldBeEqual() {
        Epic epic1 = new Epic(1, "Эпик 1", "Описание эпика 1", TaskStatus.NEW, LocalDateTime.now(),Duration.ofMinutes(10));
    ...
    public void epicIsShouldNotOwnSubtask() {
        Epic epic1 = new Epic(1, "Эпик 1", "Описание эпика 1", TaskStatus.NEW, LocalDateTime.now(), Duration.ofMinutes(10));
        Subtask subtask1 = new Subtask(2, "Первый сабтаск","Описание первого сабтаскa", TaskStatus.NEW, LocalDateTime.now(),Duration.ofMinutes(10),epic1.getId());
